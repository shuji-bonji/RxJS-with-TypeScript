...
<span class="line"><span>}, 1000);</span></span></code></pre></div><h2 id="🎓-resumen" tabindex="-1">🎓 Resumen <a class="header-anchor" href="#🎓-resumen" aria-label="Permalink to &quot;🎓 Resumen&quot;">​</a></h2><h3 id="cuando-debe-usarse-skipuntil" tabindex="-1">Cuándo debe usarse skipUntil. <a class="header-anchor" href="#cuando-debe-usarse-skipuntil" aria-label="Permalink to &quot;Cuándo debe usarse skipUntil.&quot;">​</a></h3><ul><li>✅ Si desea iniciar el procesamiento después de que se produzca un evento específico.</li><li>✅ Si desea habilitar las operaciones de usuario después de la inicialización se ha completado</li><li>✅ Si necesita un inicio diferido en función del tiempo</li><li>✅ Si desea iniciar el procesamiento de datos una vez completada la autenticación</li></ul><h3 id="en-combinacion-con-takeuntil" tabindex="-1">En combinación con takeUntil. <a class="header-anchor" href="#en-combinacion-con-takeuntil" aria-label="Permalink to &quot;En combinación con takeUntil.&quot;">​</a></h3><ul><li>✅ Si desea obtener valores sólo durante un período de tiempo específico (skipUntil + takeUntil).</li></ul><h3 id="notas" tabindex="-1">Notas. <a class="header-anchor" href="#notas" aria-label="Permalink to &quot;Notas.&quot;">​</a></h3><ul><li>⚠️ Sólo es válido el primer disparo del Observable.</li><li>⚠️ Si el Observable no se dispara, todos los valores seguirán saltando</li><li>⚠️ La suscripción se mantiene hasta que se completa el flujo original</li></ul><h2 id="🚀-proximos-pasos" tabindex="-1">🚀 Próximos pasos. <a class="header-anchor" href="#🚀-proximos-pasos" aria-label="Permalink to &quot;🚀 Próximos pasos.&quot;">​</a></h2><ul><li><strong>[skip](. /skip)</strong> - aprende a saltar los N primeros valores.</li><li><strong>[take](. /take)</strong> - aprende a obtener los N primeros valores.</li><li><strong>[takeUntil](. /utility/takeUntil)</strong> - aprende a tomar valores hasta que se dispara otro Observable.</li><li>filter](. /filter)** - aprende a filtrar en base a condiciones</li><li><strong>[filtering-operator-practical-use-cases](. /practical-use-cases)</strong> - aprende casos de uso reales</li></ul>`,46)])])}const E=a(e,[["render",l]]);export{c as __pageData,E as default};
