...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// Ausgabe.: 8(erste gerade Zahl)</span></span></code></pre></div><p><strong>Ablauf der Operation</strong>:.</p><ol><li>check 1, 3, 5, 7 → Bedingung nicht erfüllt</li><li>check 8 → Bedingung erfüllt → Ausgabe 8 und vollständig</li><li>9, 10 nicht ausgewertet</li></ol><p><a href="https://rxjs.dev/api/operators/find" target="_blank" rel="noreferrer">🌐 Offizielle RxJS Dokumentation - <code>find</code></a></p><h2 id="🆚-kontrast-zum-ersten" tabindex="-1">🆚 Kontrast zum ersten <a class="header-anchor" href="#🆚-kontrast-zum-ersten" aria-label="Permalink to &quot;🆚 Kontrast zum ersten&quot;">​</a></h2><p><code>find</code> und <code>first</code> sind ähnlich, aber ihre Verwendung ist unterschiedlich.</p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { from } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;rxjs&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"><span>// Hinweis: Obwohl das empfohlene Muster darin besteht, mit einer switchMap zu flatten,</span><span> // verschachteln wir hier das Abonnieren aus Gründen der Lesbarkeit,</span><span> // weil es eine UI-Validierung (frühe Rückkehr) enthält.</span></span>
...
<span class="line"><span>});</span></span>
<span class="line"><span>// Ausgabe: 7, 8, 9, 10, Filter abgeschlossen</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  id: Zahl</span></span>
<span class="line"><span>): Observable&lt;Aufgabe | undefiniert&gt; {</span></span>
...
<span class="line"><span>zahlen$.pipe(</span></span>
...
<span class="line"><span>).subscribe({</span></span>
<span class="line"><span>  next: console.log,.</span></span>
<span class="line"><span>  error: err =&gt; console.log(&#39;Fehler:&#39;, err) // nicht aufgerufen</span></span>
<span class="line"><span>});</span></span>
...
<span class="line"><span>ts.</span></span>
<span class="line"><span>import { from } from &#39;rxjs&#39;;</span></span>
<span class="line"><span>importiere { find, first } von &#39;rxjs&#39;;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>const numbers$ = from([1, 3, 5, 7]);</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>});</span></span>
<span class="line"><span>// Ausgabe: 0</span></span></code></pre></div><h2 id="🎓-zusammenfassung" tabindex="-1">🎓 Zusammenfassung <a class="header-anchor" href="#🎓-zusammenfassung" aria-label="Permalink to &quot;🎓 Zusammenfassung&quot;">​</a></h2><h3 id="wann-sie-find-verwenden-sollten" tabindex="-1">Wann Sie find verwenden sollten. <a class="header-anchor" href="#wann-sie-find-verwenden-sollten" aria-label="Permalink to &quot;Wann Sie find verwenden sollten.&quot;">​</a></h3><ul><li>✅ Wenn Sie den ersten Wert finden wollen, der eine Bedingung erfüllt</li><li>✅ Wenn Sie das Vorhandensein eines Wertes prüfen wollen</li><li>✅ Wenn ein Wert als &quot;undefiniert&quot; behandelt werden soll, wenn er nicht gefunden wird.</li><li>✅ Wenn Sie ein bestimmtes Element in einem Array oder einer Liste suchen wollen</li></ul><h3 id="wenn-sie-zuerst" tabindex="-1">Wenn Sie zuerst <a class="header-anchor" href="#wenn-sie-zuerst" aria-label="Permalink to &quot;Wenn Sie zuerst&quot;">​</a></h3><ul><li>✅ Wenn Sie den ersten Wert erhalten wollen</li><li>✅ Wenn Sie einen Fehler ausgeben wollen, wenn der Wert nicht gefunden wird</li></ul><h3 id="wann-sollte-der-filter-verwendet-werden" tabindex="-1">Wann sollte der Filter verwendet werden? <a class="header-anchor" href="#wann-sollte-der-filter-verwendet-werden" aria-label="Permalink to &quot;Wann sollte der Filter verwendet werden?&quot;">​</a></h3><ul><li>✅ Wenn Sie alle Werte benötigen, die eine Bedingung erfüllen</li><li>✅ Wenn Sie die Daten filtern wollen</li></ul><h3 id="anmerkungen" tabindex="-1">Anmerkungen. <a class="header-anchor" href="#anmerkungen" aria-label="Permalink to &quot;Anmerkungen.&quot;">​</a></h3><ul><li>⚠️ <code>find</code> gibt <code>undefined</code> aus, wenn nicht gefunden (kein Fehler)</li><li>⚠️ Wird sofort mit dem ersten Wert abgeschlossen, der die Bedingung erfüllt</li><li>⚠️ TypeScript gibt einen Rückgabewert vom Typ <code>T | undefined</code> aus.</li></ul><h2 id="🚀-nachster-schritt" tabindex="-1">🚀 Nächster Schritt. <a class="header-anchor" href="#🚀-nachster-schritt" aria-label="Permalink to &quot;🚀 Nächster Schritt.&quot;">​</a></h2><ul><li><strong>[first](. /first)</strong> - lernen Sie, wie Sie den ersten Wert erhalten.</li><li><strong>[filter](. /filter)</strong> - lernen Sie, wie man auf der Grundlage von Bedingungen filtert.</li><li><strong><a href="https://rxjs.dev/api/operators/findIndex" target="_blank" rel="noreferrer">findIndex</a></strong> - lernen Sie, wie man den Index des ersten Wertes, der eine Bedingung erfüllt, ermittelt (offizielle Dokumentation)</li><li><strong>[filtering-operator-practical-use-cases](. /practical-use-cases)</strong> - lernen Sie echte Anwendungsfälle kennen</li></ul>`,47)])])}const c=n(p,[["render",l]]);export{E as __pageData,c as default};
