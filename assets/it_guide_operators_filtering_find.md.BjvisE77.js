import{_ as a,o as i,c as n,a2 as p}from"./chunks/framework.B0tZAgFO.js";const c=JSON.parse(`{"title":"find - trova il primo valore che soddisfa la condizione","description":"find è un operatore di filtraggio di RxJS che trova il primo valore che soddisfa una condizione e lo invia in output, completando immediatamente il flusso. È ideale per le situazioni in cui si desidera trovare un elemento specifico da un array o da un elenco, come la ricerca di utenti, il controllo dell'inventario o il rilevamento di log di errore. Se non viene trovato alcun valore, viene emesso undefined e in TypeScript il valore di ritorno è di tipo T | undefined.","frontmatter":{"description":"find è un operatore di filtraggio di RxJS che trova il primo valore che soddisfa una condizione e lo invia in output, completando immediatamente il flusso. È ideale per le situazioni in cui si desidera trovare un elemento specifico da un array o da un elenco, come la ricerca di utenti, il controllo dell'inventario o il rilevamento di log di errore. Se non viene trovato alcun valore, viene emesso undefined e in TypeScript il valore di ritorno è di tipo T | undefined."},"headers":[],"relativePath":"it/guide/operators/filtering/find.md","filePath":"it/guide/operators/filtering/find.md","lastUpdated":1779057779000}`),e={name:"it/guide/operators/filtering/find.md"};function l(t,s,r,h,o,k){return i(),n("div",null,[...s[0]||(s[0]=[p(`<h1 id="find-trova-il-primo-valore-che-soddisfa-la-condizione" tabindex="-1">find - trova il primo valore che soddisfa la condizione <a class="header-anchor" href="#find-trova-il-primo-valore-che-soddisfa-la-condizione" aria-label="Permalink to &quot;find - trova il primo valore che soddisfa la condizione&quot;">​</a></h1><p>L&#39;operatore find trova ed emette il <strong>primo valore che soddisfa la condizione</strong> e completa immediatamente il flusso. Se non viene trovato alcun valore, viene emesso <code>undefined</code>.</p><h2 id="🔰-sintassi-e-utilizzo-di-base" tabindex="-1">🔰 Sintassi e utilizzo di base <a class="header-anchor" href="#🔰-sintassi-e-utilizzo-di-base" aria-label="Permalink to &quot;🔰 Sintassi e utilizzo di base&quot;">​</a></h2><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { from } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;rxjs&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"><span>).subscribe(console.log);.</span></span>
<span class="line"><span>// Output: 2 (indice di 30)</span></span></code></pre></div><table tabindex="0"><thead><tr><th>Operatore</th><th>Valore di ritorno</th><th>se il valore non viene trovato</th></tr></thead><tbody><tr><td><code>find(predicate)</code></td><td>Valore stesso</td><td><code>undefined</code></td></tr><tr><td><code>findIndex(predicate)</code></td><td>Indice (valore numerico)</td><td><code>-1</code></td></tr></tbody></table><h2 id="⚠️-un-errore-comune" tabindex="-1">⚠️ Un errore comune <a class="header-anchor" href="#⚠️-un-errore-comune" aria-label="Permalink to &quot;⚠️ Un errore comune&quot;">​</a></h2><div class="note custom-block github-alert"><p class="custom-block-title">NOTE</p><p><code>find</code> se il valore non viene trovato. <code>undefined</code> viene emesso. Questo non comporta un errore. Se è richiesto un errore, utilizzare <code>first</code> da utilizzare.</p></div><h3 id="errore-gestione-dell-errore-previsto-se-il-valore-non-viene-trovato" tabindex="-1">Errore.: Gestione dell&#39;errore previsto se il valore non viene trovato. <a class="header-anchor" href="#errore-gestione-dell-errore-previsto-se-il-valore-non-viene-trovato" aria-label="Permalink to &quot;Errore.: Gestione dell&#39;errore previsto se il valore non viene trovato.&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span>
<span class="line"><span>ts.</span></span>
<span class="line"><span>import { from } da &#39;rxjs&#39;;</span></span>
<span class="line"><span>import { find } from &#39;rxjs&#39;;</span></span>
<span class="line"><span></span></span>
