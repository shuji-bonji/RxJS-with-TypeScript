import{_ as a,o as i,c as n,a2 as p}from"./chunks/framework.B0tZAgFO.js";const c=JSON.parse('{"title":"Find - find o primeiro valor que satisfaz a condição","description":"O find é um operador de filtragem RxJS que encontra o primeiro valor que satisfaz uma condição e o produz, completando o fluxo imediatamente. É ideal para situações em que se deseja localizar um elemento específico de uma matriz ou lista, como pesquisar usuários, verificar o inventário ou detectar logs de erros. Se nenhum valor for encontrado, a saída será indefinida e, no TypeScript, o valor de retorno será do tipo T | undefined.","frontmatter":{"description":"O find é um operador de filtragem RxJS que encontra o primeiro valor que satisfaz uma condição e o produz, completando o fluxo imediatamente. É ideal para situações em que se deseja localizar um elemento específico de uma matriz ou lista, como pesquisar usuários, verificar o inventário ou detectar logs de erros. Se nenhum valor for encontrado, a saída será indefinida e, no TypeScript, o valor de retorno será do tipo T | undefined."},"headers":[],"relativePath":"pt/guide/operators/filtering/find.md","filePath":"pt/guide/operators/filtering/find.md","lastUpdated":1779269732000}'),e={name:"pt/guide/operators/filtering/find.md"};function l(t,s,h,r,k,o){return i(),n("div",null,[...s[0]||(s[0]=[p(`<h1 id="find-find-o-primeiro-valor-que-satisfaz-a-condicao" tabindex="-1">Find - find o primeiro valor que satisfaz a condição <a class="header-anchor" href="#find-find-o-primeiro-valor-que-satisfaz-a-condicao" aria-label="Permalink to &quot;Find - find o primeiro valor que satisfaz a condição&quot;">​</a></h1><p>O operador <code>find</code> encontra e gera o <strong>primeiro valor que satisfaz a condição</strong> e completa o fluxo imediatamente. Se nenhum valor for encontrado, ele produzirá <code>undefined</code>.</p><h2 id="sintaxe-basica-e-uso" tabindex="-1">Sintaxe básica e uso <a class="header-anchor" href="#sintaxe-basica-e-uso" aria-label="Permalink to &quot;Sintaxe básica e uso&quot;">​</a></h2><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { from } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;rxjs&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  // Subscribe: originalmente recomendado para nivelar com switchMap</span></span>
...
<span class="line"><span>      result.style.color = &#39;range&#39;; }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>  });</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// filter: gera todos os valores que correspondem à condição</span></span>
...
<span class="line"><span>});</span></span>
<span class="line"><span>// Saída: 7, 8, 9, 10, filter complete</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>numbers$.pipe(</span></span>
<span class="line"><span>  first(n =&gt; n &gt; 10, 0) // especifique o valor padrão</span></span>
<span class="line"><span>).subscribe({</span></span>
<span class="line"><span>  next: console.log,.</span></span>
<span class="line"><span>  error: err =&gt; console.log(&#39;Error:&#39;, err.message)</span></span>
<span class="line"><span>});</span></span>
<span class="line"><span>// Saída: 0</span></span></code></pre></div><h2 id="🎓-resumo" tabindex="-1">🎓 Resumo <a class="header-anchor" href="#🎓-resumo" aria-label="Permalink to &quot;🎓 Resumo&quot;">​</a></h2><h3 id="quando-voce-deve-usar-find" tabindex="-1">Quando você deve usar find. <a class="header-anchor" href="#quando-voce-deve-usar-find" aria-label="Permalink to &quot;Quando você deve usar find.&quot;">​</a></h3><ul><li>Quando você quiser encontrar o primeiro valor que satisfaça uma condição</li><li>Quando você quiser verificar a existência de um valor</li><li>Quando você quiser tratar um valor como &quot;indefinido&quot; se ele não for encontrado.</li><li>Quando você quiser encontrar um elemento específico em uma matriz ou lista</li></ul><h3 id="quando-voce-deve-usar-first" tabindex="-1">Quando você deve usar first <a class="header-anchor" href="#quando-voce-deve-usar-first" aria-label="Permalink to &quot;Quando você deve usar first&quot;">​</a></h3><ul><li>Se você quiser obter o primeiro valor</li><li>Se você quiser emitir um erro se o valor não for encontrado</li></ul><h3 id="quando-o-filter-deve-ser-usado" tabindex="-1">Quando o filter deve ser usado? <a class="header-anchor" href="#quando-o-filter-deve-ser-usado" aria-label="Permalink to &quot;Quando o filter deve ser usado?&quot;">​</a></h3><ul><li>Se você precisar de todos os valores que correspondem a uma condição</li><li>Se você quiser filtrar os dados</li></ul><h3 id="notas" tabindex="-1">Notas. <a class="header-anchor" href="#notas" aria-label="Permalink to &quot;Notas.&quot;">​</a></h3><ul><li>⚠️ <code>find</code> gera <code>undefined</code> se não for encontrado (não é um erro)</li><li>⚠️ Conclui imediatamente com o primeiro valor que satisfaz a condição</li><li>⚠️ O TypeScript fornece um valor de retorno do tipo <code>T | undefined</code>.</li></ul><h2 id="proxima-etapa" tabindex="-1">Próxima etapa. <a class="header-anchor" href="#proxima-etapa" aria-label="Permalink to &quot;Próxima etapa.&quot;">​</a></h2><ul><li><strong><a href="./first">first</a></strong> - saiba como obter o primeiro valor.</li><li><strong><a href="./filter">filter</a></strong> - saiba como filtrar com base em condições.</li><li><strong><a href="https://rxjs.dev/api/operators/findIndex" target="_blank" rel="noreferrer">findIndex</a></strong> - saiba como obter o índice do primeiro valor que satisfaz uma condição (documentação oficial)</li><li><strong><a href="./practical-use-cases">filtering-operator-practical-use-cases</a></strong> - aprenda casos de uso reais</li></ul>`,47)])])}const E=a(e,[["render",l]]);export{c as __pageData,E as default};
