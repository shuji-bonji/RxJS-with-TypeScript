import{_ as a,o as i,c as n,a2 as p}from"./chunks/framework.B0tZAgFO.js";const c=JSON.parse('{"title":"find - encuentra el primer valor que satisface la condición","description":"find es un operador de filtrado RxJS que encuentra el primer valor que satisface una condición y lo emite, completando el flujo inmediatamente. Es ideal para situaciones en las que se desea encontrar un elemento específico de una matriz o lista, como la búsqueda de usuarios, la comprobación del inventario o la detección de registros de errores. Si no se encuentra ningún valor, devuelve undefined y en TypeScript el valor devuelto es de tipo T | undefined.","frontmatter":{"description":"find es un operador de filtrado RxJS que encuentra el primer valor que satisface una condición y lo emite, completando el flujo inmediatamente. Es ideal para situaciones en las que se desea encontrar un elemento específico de una matriz o lista, como la búsqueda de usuarios, la comprobación del inventario o la detección de registros de errores. Si no se encuentra ningún valor, devuelve undefined y en TypeScript el valor devuelto es de tipo T | undefined."},"headers":[],"relativePath":"es/guide/operators/filtering/find.md","filePath":"es/guide/operators/filtering/find.md","lastUpdated":1779054497000}'),e={name:"es/guide/operators/filtering/find.md"};function l(t,s,h,r,k,d){return i(),n("div",null,[...s[0]||(s[0]=[p(`<h1 id="find-encuentra-el-primer-valor-que-satisface-la-condicion" tabindex="-1">find - encuentra el primer valor que satisface la condición <a class="header-anchor" href="#find-encuentra-el-primer-valor-que-satisface-la-condicion" aria-label="Permalink to &quot;find - encuentra el primer valor que satisface la condición&quot;">​</a></h1><p>El operador <code>find</code> encuentra y emite el <strong>primer valor que satisface la condición</strong> y completa el flujo inmediatamente. Si no se encuentra ningún valor, sale <code>undefined</code>.</p><h2 id="🔰-sintaxis-basica-y-uso" tabindex="-1">🔰 Sintaxis básica y uso <a class="header-anchor" href="#🔰-sintaxis-basica-y-uso" aria-label="Permalink to &quot;🔰 Sintaxis básica y uso&quot;">​</a></h2><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { from } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;rxjs&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// Salida.: 8(primer número par)</span></span></code></pre></div><p><strong>Flujo de operación</strong>:.</p><ol><li>comprobar 1, 3, 5, 7 → condición no cumplida.</li><li>comprobación 8 → condición cumplida → salida 8 y completa</li><li>9, 10 no evaluados</li></ol><p><a href="https://rxjs.dev/api/operators/find" target="_blank" rel="noreferrer">🌐 Documentación oficial de RxJS - <code>find</code></a></p><h2 id="🆚-contraste-con-la-primera" tabindex="-1">🆚 Contraste con la primera <a class="header-anchor" href="#🆚-contraste-con-la-primera" aria-label="Permalink to &quot;🆚 Contraste con la primera&quot;">​</a></h2><p><code>find</code> y <code>first</code> son similares, pero su uso es diferente.</p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { from } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;rxjs&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"><span>// Nota: aunque el patrón recomendado es aplanar con un switchMap,</span><span> // aquí anidamos el subscribe por legibilidad,</span><span> // ya que incluye validación UI (early return).</span></span>
...
<span class="line"><span>      result.style.color = &#39;naranja&#39;; }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>  });</span></span>
...
<span class="line"><span>ts.</span></span>
<span class="line"><span>import { from } de &#39;rxjs&#39;;</span></span>
<span class="line"><span>import { find, filter } de &#39;rxjs&#39;;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  filtro(n =&gt; n &gt; 5)</span></span>
<span class="line"><span>).subscribe({</span></span>
<span class="line"><span>  siguiente: console.log,.</span></span>
<span class="line"><span>  complete: () =&gt; console.log(&#39;filtro completado&#39;)</span></span>
<span class="line"><span>});</span></span>
<span class="line"><span>// Salida: 7, 8, 9, 10, filtro completo</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>): Observable&lt;Tarea | undefined&gt; {</span></span>
<span class="line"><span>  return tareas$.pipe(</span></span>
<span class="line"><span>    find(tarea =&gt; !tarea.completada)</span></span>
<span class="line"><span>  );</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// Ejemplo de uso</span></span>
<span class="line"><span>const tareas$ = from([.</span></span>
<span class="line"><span>  { id: 1, title: &#39;Tarea A&#39;, completada: true, prioridad: &#39;alta&#39; as const }</span></span>
<span class="line"><span>  { id: 2, title: &#39;Tarea B&#39;, completada: false, prioridad: &#39;media&#39; as const }</span></span>
...
<span class="line"><span>ts.</span></span>
<span class="line"><span>import { from } de &#39;rxjs&#39;;</span></span>
<span class="line"><span>import { find, first } de &#39;rxjs&#39;;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>const números$ = from([1, 3, 5, 7]);</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// ✅ Buen ejemplo 2: usa el primero si necesitas un error</span></span>
