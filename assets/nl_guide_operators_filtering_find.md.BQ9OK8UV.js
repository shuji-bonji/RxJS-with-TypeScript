...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// Uitgang.: 8(eerste even getal)</span></span></code></pre></div><p><strong>Bewerkingsstroom</strong>:.</p><ol><li>controleer 1, 3, 5, 7 → voorwaarde niet vervuld</li><li>controleer 8 → voorwaarde vervuld → uitvoer 8 en compleet</li><li>9, 10 niet geëvalueerd</li></ol><p><a href="https://rxjs.dev/api/operators/find" target="_blank" rel="noreferrer">🌐 Officiële RxJS documentatie - <code>find</code></a></p><h2 id="🆚-contrast-met-eerste" tabindex="-1">🆚 Contrast met eerste <a class="header-anchor" href="#🆚-contrast-met-eerste" aria-label="Permalink to &quot;🆚 Contrast met eerste&quot;">​</a></h2><p><code>find</code> en <code>first</code> lijken op elkaar, maar ze worden anders gebruikt.</p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { from } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;rxjs&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"><span>import { find } van &#39;rxjs&#39;;</span></span>
...
<span class="line"><span>// Opmerking: Hoewel het aanbevolen patroon is om af te vlakken met een switchMap,</span><span> // nestelen we hier de subscribe voor leesbaarheid,</span><span> // omdat het UI-validatie bevat (vroege terugkeer).</span></span>
<span class="line"><span>// Overweeg een platte implementatie met \`switchMap\` in productiecode.</span></span>
...
<span class="line"><span>  van(producten).pipe(</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// filter: uitvoer alle waarden die voldoen aan de voorwaarde</span></span>
...
<span class="line"><span>  volgende: console.log,.</span></span>
<span class="line"><span>  compleet: () =&gt; console.log(&#39;filter compleet&#39;)</span></span>
<span class="line"><span>});</span></span>
...
<span class="line"><span>  voltooid: booleaans;</span></span>
<span class="line"><span>  priority: &#39;high&#39; | &#39;medium&#39; | &#39;low&#39;; }</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>functie findTaskById(</span></span>
<span class="line"><span>  taken$: waarneembare&lt;taak&gt;,.</span></span>
<span class="line"><span>  id: getal</span></span>
<span class="line"><span>): waarneembaar&lt;taak | ongedefinieerd&gt; {</span></span>
...
<span class="line"><span>  taken$: waarneembare&lt;taak&gt;</span></span>
<span class="line"><span>): Waarneembare&lt;Taak | ongedefinieerd&gt; {</span></span>
<span class="line"><span>  return taken$.pipe(</span></span>
...
<span class="line"><span>  { id: 1, titel: &#39;Taak A&#39;, voltooid: waar, prioriteit: &#39;hoog&#39; als const }</span></span>
<span class="line"><span>  { id: 2, titel: &#39;Taak B&#39;, voltooid: onwaar, prioriteit: &#39;gemiddeld&#39; als const }</span></span>
<span class="line"><span>  { id: 3, titel: &#39;Taak C&#39;, voltooid: onwaar, prioriteit: &#39;laag&#39; als const }.</span></span>
...
<span class="line"><span>findFirstIncompleteTask(taken$).subscribe(taak =&gt; {</span></span>
<span class="line"><span>  if (taak) {</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// findIndex: geef index terug</span></span>
<span class="line"><span>getallen$.pipe(</span></span>
<span class="line"><span>  findIndex(n =&gt; n &gt; 25)</span></span>
<span class="line"><span>).subscribe(console.log);.</span></span>
<span class="line"><span>// Uitvoer: 2 (index van 30)</span></span></code></pre></div><table tabindex="0"><thead><tr><th>Operator</th><th>Waarde retourneren</th><th>als de waarde niet is gevonden</th></tr></thead><tbody><tr><td><code>find(predicate)</code></td><td>Waarde zelf</td><td><code>undefined</code></td></tr><tr><td><code>findIndex(predicate)</code></td><td>Index (numerieke waarde)</td><td><code>-1</code></td></tr></tbody></table><h2 id="⚠️-veelvoorkomende-fouten" tabindex="-1">⚠️ Veelvoorkomende fouten <a class="header-anchor" href="#⚠️-veelvoorkomende-fouten" aria-label="Permalink to &quot;⚠️ Veelvoorkomende fouten&quot;">​</a></h2><div class="note custom-block github-alert"><p class="custom-block-title">NOTE</p><p><code>find</code> als de waarde niet wordt gevonden. <code>undefined</code> wordt uitgevoerd. Dit resulteert niet in een fout. Als een fout vereist is, moet <code>first</code> gebruikt worden.</p></div><h3 id="fout-verwachte-foutafhandeling-als-de-waarde-niet-wordt-gevonden" tabindex="-1">Fout.: Verwachte foutafhandeling als de waarde niet wordt gevonden. <a class="header-anchor" href="#fout-verwachte-foutafhandeling-als-de-waarde-niet-wordt-gevonden" aria-label="Permalink to &quot;Fout.: Verwachte foutafhandeling als de waarde niet wordt gevonden.&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span>
<span class="line"><span>ts.</span></span>
<span class="line"><span>import { from } from &#39;rxjs&#39;;</span></span>
<span class="line"><span>import { find } from &#39;rxjs&#39;;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>).subscribe({</span></span>
<span class="line"><span>  volgende: console.log,.</span></span>
<span class="line"><span>  error: err =&gt; console.log(&#39;Fout:&#39;, err) // niet aangeroepen</span></span>
<span class="line"><span>});</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// ✅ Goed voorbeeld 2: gebruik het eerste als je een foutmelding nodig hebt</span></span>
<span class="line"><span>getallen$.pipe(</span></span>
<span class="line"><span>  first(n =&gt; n &gt; 10, 0) // standaardwaarde opgeven</span></span>
<span class="line"><span>).subscribe({</span></span>
<span class="line"><span>  next: console.log,.</span></span>
<span class="line"><span>  error: err =&gt; console.log(&#39;Fout:&#39;, err.message)</span></span>
<span class="line"><span>});</span></span>
<span class="line"><span>// Uitvoer: 0</span></span></code></pre></div><h2 id="samenvatting" tabindex="-1">Samenvatting <a class="header-anchor" href="#samenvatting" aria-label="Permalink to &quot;Samenvatting&quot;">​</a></h2><h3 id="wanneer-je-find-moet-gebruiken" tabindex="-1">Wanneer je find moet gebruiken. <a class="header-anchor" href="#wanneer-je-find-moet-gebruiken" aria-label="Permalink to &quot;Wanneer je find moet gebruiken.&quot;">​</a></h3><ul><li>✅ Als je de eerste waarde wilt vinden die aan een voorwaarde voldoet</li><li>✅ Als je het bestaan van een waarde wilt controleren</li><li>✅ Als je een waarde als <code>undefined</code> wilt behandelen als deze niet wordt gevonden.</li><li>✅ Wanneer je een specifiek element in een array of lijst wilt vinden</li></ul><h3 id="wanneer-je-eerst-moet-gebruiken" tabindex="-1">Wanneer je eerst moet gebruiken <a class="header-anchor" href="#wanneer-je-eerst-moet-gebruiken" aria-label="Permalink to &quot;Wanneer je eerst moet gebruiken&quot;">​</a></h3><ul><li>✅ Als je de eerste waarde wilt krijgen</li><li>✅ Als je een foutmelding wilt geven als de waarde niet wordt gevonden</li></ul><h3 id="wanneer-moet-een-filter-worden-gebruikt" tabindex="-1">Wanneer moet een filter worden gebruikt? <a class="header-anchor" href="#wanneer-moet-een-filter-worden-gebruikt" aria-label="Permalink to &quot;Wanneer moet een filter worden gebruikt?&quot;">​</a></h3><ul><li>✅ Als u alle waarden nodig hebt die aan een voorwaarde voldoen</li><li>✅ Als u de gegevens wilt filteren</li></ul><h3 id="opmerkingen" tabindex="-1">Opmerkingen. <a class="header-anchor" href="#opmerkingen" aria-label="Permalink to &quot;Opmerkingen.&quot;">​</a></h3><ul><li>⚠️ <code>find</code> geeft <code>undefined</code> als het niet gevonden wordt (geen fout)</li><li>⚠️ Beëindigt onmiddellijk met de eerste waarde die aan de voorwaarde voldoet</li><li>⚠️ TypeScript geeft een retourwaarde van het type <code>T | undefined</code>.</li></ul><h2 id="volgende-stap" tabindex="-1">Volgende stap. <a class="header-anchor" href="#volgende-stap" aria-label="Permalink to &quot;Volgende stap.&quot;">​</a></h2><ul><li><strong>[first](. /first)</strong> - leer hoe je de eerste waarde krijgt.</li><li><strong>[filter](. /filter)</strong> - leer filteren op basis van voorwaarden.</li><li><strong><a href="https://rxjs.dev/api/operators/findIndex" target="_blank" rel="noreferrer">findIndex</a></strong> - leer hoe u de index krijgt van de eerste waarde die voldoet aan een voorwaarde (officiële documentatie)</li><li><strong>[filtering-operator-praktische-gebruik-cases](. /practical-use-cases)</strong> - leer echte gebruikssituaties</li></ul>`,47)])])}const g=a(p,[["render",l]]);export{E as __pageData,g as default};
