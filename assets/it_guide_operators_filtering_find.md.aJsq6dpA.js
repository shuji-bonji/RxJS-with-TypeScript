import{_ as a,o as i,c as n,a2 as p}from"./chunks/framework.B0tZAgFO.js";const c=JSON.parse(`{"title":"trova - trova il primo valore che soddisfa la condizione","description":"find è un operatore di filtraggio RxJS che trova il primo valore che soddisfa una condizione e lo invia in output, completando immediatamente il flusso. È ideale per le situazioni in cui si desidera trovare un elemento specifico da un array o da un elenco, come la ricerca di utenti, il controllo dell'inventario o il rilevamento di log di errore. Se non viene trovato alcun valore, viene emesso undefined e in TypeScript il valore di ritorno è di tipo T | undefined.","frontmatter":{"description":"find è un operatore di filtraggio RxJS che trova il primo valore che soddisfa una condizione e lo invia in output, completando immediatamente il flusso. È ideale per le situazioni in cui si desidera trovare un elemento specifico da un array o da un elenco, come la ricerca di utenti, il controllo dell'inventario o il rilevamento di log di errore. Se non viene trovato alcun valore, viene emesso undefined e in TypeScript il valore di ritorno è di tipo T | undefined."},"headers":[],"relativePath":"it/guide/operators/filtering/find.md","filePath":"it/guide/operators/filtering/find.md","lastUpdated":1779054497000}`),e={name:"it/guide/operators/filtering/find.md"};function l(t,s,r,h,o,k){return i(),n("div",null,[...s[0]||(s[0]=[p(`<h1 id="trova-trova-il-primo-valore-che-soddisfa-la-condizione" tabindex="-1">trova - trova il primo valore che soddisfa la condizione <a class="header-anchor" href="#trova-trova-il-primo-valore-che-soddisfa-la-condizione" aria-label="Permalink to &quot;trova - trova il primo valore che soddisfa la condizione&quot;">​</a></h1><p>L&#39;operatore <code>find</code> trova ed emette il <strong>primo valore che soddisfa la condizione</strong> e completa immediatamente il flusso. Se non viene trovato alcun valore, viene emesso <code>undefined</code>.</p><h2 id="🔰-sintassi-e-uso-di-base" tabindex="-1">🔰 Sintassi e uso di base <a class="header-anchor" href="#🔰-sintassi-e-uso-di-base" aria-label="Permalink to &quot;🔰 Sintassi e uso di base&quot;">​</a></h2><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { from } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;rxjs&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// Uscita.: 8(primo numero pari)</span></span></code></pre></div><p><strong>Flusso delle operazioni</strong>:.</p><ol><li>controllo 1, 3, 5, 7 → condizione non soddisfatta</li><li>controllo 8 → condizione soddisfatta → uscita 8 e completa</li><li>9, 10 non valutati</li></ol><p><a href="https://rxjs.dev/api/operators/find" target="_blank" rel="noreferrer">🌐 Documentazione ufficiale di RxJS - <code>find</code></a></p><h2 id="🆚-contrasto-con-il-primo" tabindex="-1">🆚 Contrasto con il primo <a class="header-anchor" href="#🆚-contrasto-con-il-primo" aria-label="Permalink to &quot;🆚 Contrasto con il primo&quot;">​</a></h2><p><code>find</code> e <code>first</code> sono simili, ma il loro utilizzo è diverso.</p><p>{\\AN8}CONOSCENZA_2___</p><table tabindex="0"><thead><tr><th>Operatore.</th><th>Specifica della condizione</th><th>Se non viene trovato alcun valore</th><th>Caso d&#39;uso.</th></tr></thead><tbody><tr><td><code>primo()</code></td><td>Opzione</td><td>Errore (<code>EmptyError</code>)</td><td>Ottenere il primo valore</td></tr><tr><td><code>primo(predicato)</code></td><td>Opzionale</td><td>Errore (<code>EmptyError</code>)</td><td>Ottenere in modo condizionale.</td></tr><tr><td>Trova (predicato)</td><td>Richiesto.</td><td>Uscita <code>indefinita</code>.</td><td>Ricerca e controllo dell&#39;esistenza</td></tr></tbody></table><h2 id="💡-modello-di-utilizzo-tipico" tabindex="-1">💡 Modello di utilizzo tipico <a class="header-anchor" href="#💡-modello-di-utilizzo-tipico" aria-label="Permalink to &quot;💡 Modello di utilizzo tipico&quot;">​</a></h2><ol><li><strong>Ricerca dell&#39;utente</strong>.</li></ol><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">   import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { from } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;rxjs&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">   import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { find } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;rxjs&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"></span>
...
<span class="line"><span>importare { find } da &#39;rxjs&#39;;</span></span>
...
<span class="line"><span>  { id: &#39;P2&#39;, nome: &#39;Tastiera meccanica&#39;, prezzo: 8980, categoria: &#39;Periferiche per PC&#39; }</span></span>
...
<span class="line"><span>// Nota: sebbene lo schema raccomandato sia quello di appiattire con una switchMap,</span><span> // qui annidiamo la sottoscrizione per la leggibilità,</span><span> // perché include la validazione dell&#39;interfaccia utente (ritorno anticipato).</span></span>
<span class="line"><span>// Considerare un&#39;implementazione piatta usando \`switchMap\` nel codice di produzione.</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  // Sottoscrizione del nido: originariamente si consigliava di appiattire con switchMap</span></span>
...
<span class="line"><span>      result.style.color = &#39;arancione&#39;; }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>  });</span></span>
...
<span class="line"><span>importare { find, filter } da &#39;rxjs&#39;;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>const numbers$ = from([1, 3, 5, 7, 8, 9, 10]);</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// filtro: produce tutti i valori che corrispondono alla condizione</span></span>
...
<span class="line"><span>  complete: () =&gt; console.log(&#39;filtro completato&#39;)</span></span>
<span class="line"><span>});</span></span>
<span class="line"><span>// Output: 7, 8, 9, 10, filtro completato</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  id: numero</span></span>
<span class="line"><span>): Osservabile&lt;Compito | indefinito&gt; {</span></span>
...
<span class="line"><span>  tasks$: osservabile&lt;compito&gt;</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// Trova i compiti non completati</span></span>
...
<span class="line"><span>ts</span></span>
<span class="line"><span>importare { from } da &#39;rxjs&#39;;</span></span>
<span class="line"><span>importare { find, findIndex } da &#39;rxjs&#39;;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>ts.</span></span>
<span class="line"><span>importare { from } da &#39;rxjs&#39;;</span></span>
<span class="line"><span>importare { find, first } da &#39;rxjs&#39;;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>const numbers$ = from([1, 3, 5, 7]);</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// ✅ Buon esempio 2: utilizzare il primo se si ha bisogno di un errore</span></span>
<span class="line"><span>numbers$.pipe(</span></span>
...
<span class="line"><span>});</span></span>
<span class="line"><span>// Uscita: 0</span></span></code></pre></div><h2 id="🎓-riepilogo" tabindex="-1">🎓 Riepilogo <a class="header-anchor" href="#🎓-riepilogo" aria-label="Permalink to &quot;🎓 Riepilogo&quot;">​</a></h2><h3 id="quando-si-dovrebbe-usare-find" tabindex="-1">Quando si dovrebbe usare find. <a class="header-anchor" href="#quando-si-dovrebbe-usare-find" aria-label="Permalink to &quot;Quando si dovrebbe usare find.&quot;">​</a></h3><ul><li>✅ Se si vuole trovare il primo valore che soddisfa una condizione</li><li>✅ Quando si vuole verificare l&#39;esistenza di un valore</li><li>✅ Quando si vuole trattare un valore come <code>undefined</code> se non viene trovato.</li><li>✅ Quando si vuole trovare un elemento specifico in una matrice o in un elenco</li></ul><h3 id="quando-si-dovrebbe-usare-prima" tabindex="-1">Quando si dovrebbe usare prima <a class="header-anchor" href="#quando-si-dovrebbe-usare-prima" aria-label="Permalink to &quot;Quando si dovrebbe usare prima&quot;">​</a></h3><ul><li>✅ Se si vuole ottenere il primo valore</li><li>✅ Se si vuole dare un errore se il valore non è trovato</li></ul><h3 id="quando-si-dovrebbe-usare-il-filtro" tabindex="-1">Quando si dovrebbe usare il filtro? <a class="header-anchor" href="#quando-si-dovrebbe-usare-il-filtro" aria-label="Permalink to &quot;Quando si dovrebbe usare il filtro?&quot;">​</a></h3><ul><li>✅ Se si ha bisogno di tutti i valori che corrispondono a una condizione</li><li>✅ Se si vogliono filtrare i dati</li></ul><h3 id="note" tabindex="-1">Note. <a class="header-anchor" href="#note" aria-label="Permalink to &quot;Note.&quot;">​</a></h3><ul><li>⚠️ <code>find</code> restituisce <code>undefined</code> se non viene trovato (non è un errore).</li><li>⚠️ Completa immediatamente con il primo valore che soddisfa la condizione</li><li>⚠️ TypeScript restituisce un valore di tipo <code>T | undefined</code>.</li></ul><h2 id="🚀-passo-successivo" tabindex="-1">🚀 Passo successivo. <a class="header-anchor" href="#🚀-passo-successivo" aria-label="Permalink to &quot;🚀 Passo successivo.&quot;">​</a></h2><ul><li><strong>[first](. /first)</strong> - imparare a ottenere il primo valore.</li><li><strong>[filter](. /filtro)</strong> - imparare a filtrare in base alle condizioni.</li><li><strong><a href="https://rxjs.dev/api/operators/findIndex" target="_blank" rel="noreferrer">findIndex</a></strong> - per imparare a ottenere l&#39;indice del primo valore che soddisfa una condizione (documentazione ufficiale).</li><li><strong>[filtering-operator-practical-use-cases](. /practical-use-cases)</strong> - per imparare casi d&#39;uso reali.</li></ul>`,47)])])}const E=a(e,[["render",l]]);export{c as __pageData,E as default};
