...
<span class="line"><span>fromEvent(document, &#39;click&#39;).pipe(</span></span>
<span class="line"><span>  auditTime(1000)</span></span>
<span class="line"><span>).subscribe(() =&gt; console.log(&#39;Clic!&#39;));</span></span></code></pre></div><p>ts. import { fromEvent } from &#39;rxjs&#39;; import { debounceTime } from &#39;rxjs&#39;;</p><p>// Creare un campo di input per la ricerca const input = document.createElement(&#39;input&#39;);. input.type = &#39;text&#39;; input.placeholder = &#39;Cerca...&#39; ; document.body.appendChild(input);</p><p>// ✅ Buon esempio: usare debounceTime per l&#39;input di ricerca fromEvent(input, &#39;input&#39;).pipe( debounceTime(300) // Attendere 300 ms dopo l&#39;arresto dell&#39;input prima di eseguire la ricerca ).subscribe(() =&gt; { console.log(&#39;Ricerca eseguita&#39;, input.value); });</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span>
