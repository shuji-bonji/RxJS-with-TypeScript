...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// Sortie.: 8(premier nombre pair)</span></span></code></pre></div><p><strong>Flux d&#39;opérations</strong> :.</p><ol><li>vérifier 1, 3, 5, 7 → condition non remplie</li><li>contrôle 8 → condition remplie → sortie 8 et complète</li><li>9, 10 non évalués</li></ol><p><a href="https://rxjs.dev/api/operators/find" target="_blank" rel="noreferrer">🌐 Official RxJS documentation - <code>find</code></a></p><h2 id="🆚-contraste-avec-first" tabindex="-1">🆚 Contraste avec first <a class="header-anchor" href="#🆚-contraste-avec-first" aria-label="Permalink to &quot;🆚 Contraste avec first&quot;">​</a></h2><p><code>find</code> et <code>first</code> sont similaires, mais leur utilisation est différente.</p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { from } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;rxjs&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"><span>// Note : à l&#39;origine, le schéma recommandé est d&#39;aplatir avec un switchMap, mais,</span></span>
<span class="line"><span>// Note : Bien que le pattern recommandé soit d&#39;aplatir avec un switchMap,</span><span> // ici nous imbriquons le subscribe pour la lisibilité,</span><span> // parce qu&#39;il inclut la validation de l&#39;IU (retour anticipé).</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  // Nest subscribe : recommandé à l&#39;origine pour aplatir avec switchMap</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// filter : sort toutes les valeurs qui correspondent à la condition</span></span>
...
<span class="line"><span>  complete : booléen ;</span></span>
...
<span class="line"><span>  { id : 1, title : &#39;Tâche A&#39;, complete : true, priority : &#39;high&#39; as const }</span></span>
<span class="line"><span>  { id : 2, title : &#39;Tâche B&#39;, complete : false, priority : &#39;medium&#39; as const }</span></span>
<span class="line"><span>  { id : 3, title : &#39;Tâche C&#39;, complete : false, priority : &#39;low&#39; as const }</span></span>
...
<span class="line"><span>).subscribe(console.log) ;.</span></span>
<span class="line"><span>// Résultat : 2 (indice de 30)</span></span></code></pre></div><table tabindex="0"><thead><tr><th>Opérateur</th><th>Retourner la valeur</th><th>si la valeur n&#39;est pas trouvée</th></tr></thead><tbody><tr><td><code>find(predicate)</code></td><td>Valeur elle-même</td><td><code>undefined</code></td></tr><tr><td><code>findIndex(predicate)</code></td><td>Index (valeur numérique)</td><td><code>-1</code></td></tr></tbody></table><h2 id="⚠️-une-erreur-frequente" tabindex="-1">⚠️ Une erreur fréquente <a class="header-anchor" href="#⚠️-une-erreur-frequente" aria-label="Permalink to &quot;⚠️ Une erreur fréquente&quot;">​</a></h2><div class="note custom-block github-alert"><p class="custom-block-title">NOTE</p><p><code>find</code> si la valeur n&#39;est pas trouvée. <code>undefined</code> est affiché. Cela n&#39;entraîne pas d&#39;erreur. Si une erreur est nécessaire, il faut utiliser <code>first</code> pour être utilisée.</p></div><h3 id="erreur-traitement-de-l-erreur-attendue-si-la-valeur-n-est-pas-trouvee" tabindex="-1">Erreur.: Traitement de l&#39;erreur attendue si la valeur n&#39;est pas trouvée. <a class="header-anchor" href="#erreur-traitement-de-l-erreur-attendue-si-la-valeur-n-est-pas-trouvee" aria-label="Permalink to &quot;Erreur.: Traitement de l&#39;erreur attendue si la valeur n&#39;est pas trouvée.&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span>
<span class="line"><span>ts.</span></span>
<span class="line"><span>import { from } from &#39;rxjs&#39; ;</span></span>
<span class="line"><span>import { find } from &#39;rxjs&#39; ;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>).subscribe({</span></span>
<span class="line"><span>  next : console.log, .</span></span>
<span class="line"><span>  error : err =&gt; console.log(&#39;Error:&#39;, err) // non appelé</span></span>
<span class="line"><span>}) ;</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// ✅ Bon exemple 2 : utilisez le first si vous avez besoin d&#39;une erreur</span></span>
<span class="line"><span>numbers$.pipe(</span></span>
...
<span class="line"><span>}) ;</span></span>
<span class="line"><span>// Sortie : 0</span></span></code></pre></div><h2 id="🎓-resume" tabindex="-1">🎓 Résumé <a class="header-anchor" href="#🎓-resume" aria-label="Permalink to &quot;🎓 Résumé&quot;">​</a></h2><h3 id="quand-utiliser-find" tabindex="-1">Quand utiliser find. <a class="header-anchor" href="#quand-utiliser-find" aria-label="Permalink to &quot;Quand utiliser find.&quot;">​</a></h3><ul><li>✅ Si vous voulez trouver la première valeur qui satisfait une condition.</li><li>✅ Lorsque vous voulez vérifier l&#39;existence d&#39;une valeur</li><li>✅ Lorsque vous voulez traiter une valeur comme <code>undefined</code> si elle n&#39;est pas trouvée.</li><li>✅ Lorsque vous voulez trouver un élément spécifique dans un tableau ou une liste</li></ul><h3 id="quand-vous-devez-utiliser-first" tabindex="-1">Quand vous devez utiliser first <a class="header-anchor" href="#quand-vous-devez-utiliser-first" aria-label="Permalink to &quot;Quand vous devez utiliser first&quot;">​</a></h3><ul><li>✅ Si vous voulez obtenir la première valeur</li><li>✅ Si vous voulez afficher une erreur si la valeur n&#39;est pas trouvée</li></ul><h3 id="quand-faut-il-utiliser-le-filtre" tabindex="-1">Quand faut-il utiliser le filtre ? <a class="header-anchor" href="#quand-faut-il-utiliser-le-filtre" aria-label="Permalink to &quot;Quand faut-il utiliser le filtre ?&quot;">​</a></h3><ul><li>✅ Si vous avez besoin de toutes les valeurs correspondant à une condition</li><li>✅ Si vous voulez filtrer les données</li></ul><h3 id="notes" tabindex="-1">Notes. <a class="header-anchor" href="#notes" aria-label="Permalink to &quot;Notes.&quot;">​</a></h3><ul><li>⚠️ <code>find</code> produit <code>undefined</code> s&#39;il n&#39;est pas trouvé (ce n&#39;est pas une erreur)</li><li>⚠️ Complète immédiatement avec la première valeur qui satisfait la condition</li><li>⚠️ TypeScript donne une valeur de retour de type <code>T | undefined</code>.</li></ul><h2 id="🚀-prochaine-etape" tabindex="-1">🚀 Prochaine étape. <a class="header-anchor" href="#🚀-prochaine-etape" aria-label="Permalink to &quot;🚀 Prochaine étape.&quot;">​</a></h2><ul><li><strong><a href="./first">first</a></strong> - apprendre à obtenir la première valeur.</li><li><strong><a href="./filter">filter</a></strong> - Apprenez à filtrer sur la base de conditions.</li><li><strong><a href="https://rxjs.dev/api/operators/findIndex" target="_blank" rel="noreferrer">findIndex</a></strong> - apprendre à obtenir l&#39;index de la première valeur qui satisfait une condition (documentation officielle).</li><li><strong><a href="./practical-use-cases">filtering-operator-practical-use-cases</a></strong> - apprendre des cas d&#39;utilisation réels</li></ul>`,47)])])}const E=i(p,[["render",l]]);export{c as __pageData,E as default};
