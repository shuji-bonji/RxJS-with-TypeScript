...
|------|------|-----------|---------|
| [ajax()](/en/guide/creation-functions/http-communication/ajax) | XMLHttpRequest-based HTTP communication | XMLHttpRequest | Legacy browser support, progress monitoring |
| [fromFetch()](/en/guide/creation-functions/http-communication/fromFetch) | Fetch API-based HTTP communication | Fetch API | Modern browsers, lightweight HTTP communication |
...
- [ajax() in detail](/en/guide/creation-functions/http-communication/ajax) - XMLHttpRequest-based HTTP communication
- [fromFetch() in detail](/en/guide/creation-functions/http-communication/fromFetch) - Fetch API-based HTTP communication
