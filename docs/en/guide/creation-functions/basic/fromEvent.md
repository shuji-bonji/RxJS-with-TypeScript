...
|----------|------|----------|
| **[from()](/en/guide/creation-functions/basic/from)** | Convert from array/Promise | Stream data other than events |
| **[interval()](/en/guide/creation-functions/basic/interval)** | Emit at regular intervals | Periodic processing needed |
...
- [interval() - Emit Values at Regular Intervals](/en/guide/creation-functions/basic/interval)
- [timer() - Start Emitting After Delay](/en/guide/creation-functions/basic/timer)
