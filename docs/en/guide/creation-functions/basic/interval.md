...
|----------|------|----------|
| **[timer()](/en/guide/creation-functions/basic/timer)** | Starts after delay, or emits only once | Delayed execution or one-time processing |
| **[fromEvent()](/en/guide/creation-functions/basic/fromEvent)** | Event-driven | Processing according to user operations |
