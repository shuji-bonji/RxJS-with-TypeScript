...
- [using()](/en/guide/creation-functions/control/using) - Observable with resource control
- [Control Creation Functions](/en/guide/creation-functions/control/) - Comparison of scheduled() and using()
- [Scheduler Types](/en/guide/schedulers/types) - Scheduler details
- [from()](/en/guide/creation-functions/basic/from) - Basic Observable generation
