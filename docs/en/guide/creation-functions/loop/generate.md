...
- [range()](/en/guide/creation-functions/loop/range) - Simple sequential number generation
- [defer()](/en/guide/creation-functions/conditional/defer) - Dynamic generation on subscription
- [expand()](/en/guide/operators/transformation/expand) - Recursive expansion (higher-order operator)
- [scan()](/en/guide/operators/transformation/scan) - Cumulative calculation
