...
class UserService {
  ...
  private userCache$ = ajax.getJSON<User>('https://jsonplaceholder.typicode.com/users/1').pipe(
    ...
    shareReplay({ bufferSize: 1, refCount: true }) // Cache the last value (released when all subscribers unsubscribe via refCount)
  );
...
- **[share()](/en/guide/operators/multicasting/share)** - Simple multicast (no buffering)
- **[publish()](/en/guide/subjects/multicasting)** - Low-level multicast control
- **[ReplaySubject](/en/guide/subjects/types-of-subject)** - Subject that forms the basis of shareReplay
...
- **[Common Mistakes and Solutions](/en/guide/anti-patterns/common-mistakes#4-misuse-of-sharereplay)** - Proper use of shareReplay and memory leak countermeasures
- **[share()](/en/guide/operators/multicasting/share)** - Simple multicast
- **[ReplaySubject](/en/guide/subjects/types-of-subject)** - Subject that forms the basis of shareReplay
