...
- **[takeWhile](/en/guide/operators/filtering/takeWhile)** - Take values only while condition is met
- **[skip](/en/guide/operators/filtering/skip)** - Skip first N values
- **[skipLast](/en/guide/operators/filtering/skipLast)** - Skip last N values
- **[skipUntil](/en/guide/operators/filtering/skipUntil)** - Skip until another Observable fires
- **[filter](/en/guide/operators/filtering/filter)** - Only pass values matching condition
