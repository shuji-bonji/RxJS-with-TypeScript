...
- **[take](/en/guide/operators/filtering/take)** - Learn how to get the first N values
- **[first](/en/guide/operators/filtering/first)** - Learn how to get the first value or the first value that satisfies a condition
- **[last](/en/guide/operators/filtering/last)** - Learn how to get the last value
