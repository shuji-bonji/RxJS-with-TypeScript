...
Promise-based code tends to complicate asynchronous testing. See [Testing Methodology](/en/guide/testing/unit-tests) for details.
...
- **[Difference between Promise and RxJS](/en/guide/basics/promise-vs-rxjs)** - Basic conversion methods
- **[Error Handling](/en/guide/error-handling/strategies)** - Observable error handling strategies
- **[Common Mistakes and How to Deal with Them](/en/guide/anti-patterns/common-mistakes)** - Other anti-patterns
