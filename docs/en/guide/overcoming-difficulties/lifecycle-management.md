...
→ **[Operator Selection Difficulties](/en/guide/overcoming-difficulties/operator-selection)** - Criteria for choosing the right one from over 100 operators

## Related Pages

- **[Chapter 2: Observable Lifecycle](/en/guide/observables/observable-lifecycle)** - Basics of subscribe/unsubscribe
- **[Chapter 10: Common Mistakes and Solutions](/en/guide/anti-patterns/common-mistakes)** - Nested subscribe, memory leaks, etc.
- **[Chapter 13: Form Processing Patterns](/en/guide/)** - Practical use (in preparation)
- **[Chapter 8: Debugging Memory Leaks](/en/guide/debugging/)** - How to debug
