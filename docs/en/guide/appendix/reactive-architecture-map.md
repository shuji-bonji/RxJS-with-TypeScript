...
- [Embedded Development and Reactive Programming](/en/guide/appendix/embedded-reactive-programming) - IoT/Embedded Layer Details
- [Reactive methods other than ReactiveX](/en/guide/appendix/reactive-patterns-beyond-rxjs) - Specific implementation methods for each layer
- [Introduction to RxJS](/en/guide/introduction) - Basic Concepts of RxJS
- [What is Observable?](/en/guide/observables/what-is-observable) - Observable Basics
- [Combination Operators](/en/guide/operators/combination/) - Multiple stream integration
