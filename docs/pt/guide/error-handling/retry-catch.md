...
>
> For more information, see [Scheduler Types and Usage - Controlling Error Retries](/pt/guide/schedulers/types#error-retry-control).
...
>
> **Related Information**:
> - For retry timing control, see [Scheduler Types and Usage - Controlling Error Retries](/pt/guide/schedulers/types#error-retry-control)
> - For the overall picture of debugging techniques, see [RxJS Debugging Techniques - Tracking Retry Attempts](/pt/guide/debugging/#scenario-6-tracking-retry-attempts)
