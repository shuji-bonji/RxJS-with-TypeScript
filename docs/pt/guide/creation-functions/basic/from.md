...
|----------|------|----------|
| **[of()](/pt/guide/creation-functions/basic/of)** | Emit arguments in sequence | Want to emit values as-is |
| **[fromEvent()](/pt/guide/creation-functions/basic/fromEvent)** | Stream events | Handle DOM events or EventEmitter |
| **[defer()](/pt/guide/creation-functions/conditional/defer)** | Defer generation until subscription | Need lazy Promise execution |
