...
|----------|------|----------|
| **[interval()](/pt/guide/creation-functions/basic/interval)** | Starts immediately (no delay) | Periodic execution without delay |
| **[of()](/pt/guide/creation-functions/basic/of)** | Emit synchronously and immediately | When asynchronous is not needed |
...
- [interval() - Continuous Emission at Specified Intervals](/pt/guide/creation-functions/basic/interval)
- [defer() - Defer Generation Until Subscription](/pt/guide/creation-functions/conditional/defer)
