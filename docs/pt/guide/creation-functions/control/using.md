...
- [scheduled()](/pt/guide/creation-functions/control/scheduled) - Generate Observable with specified scheduler
- [Control Creation Functions](/pt/guide/creation-functions/control/) - Comparison of scheduled() and using()
- [finalize()](/pt/guide/error-handling/finalize) - Operator to add processing at end of subscription
