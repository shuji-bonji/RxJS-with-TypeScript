...
- **[shareReplay()](/pt/guide/operators/multicasting/shareReplay)** - Buffers past values and provides them to subsequent subscribers
- **[Subject](/pt/guide/subjects/what-is-subject)** - The class that forms the basis of multicasting
