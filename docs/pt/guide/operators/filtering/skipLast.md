...
- **[takeLast](/pt/guide/operators/filtering/takeLast)** - Take only last N values
- **[take](/pt/guide/operators/filtering/take)** - Take only first N values
- **[skipUntil](/pt/guide/operators/filtering/skipUntil)** - Skip until another Observable fires
- **[skipWhile](/pt/guide/operators/filtering/skipWhile)** - Skip while condition is met
