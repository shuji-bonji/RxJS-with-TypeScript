...
| [concatAll](/pt/guide/operators/combination/concatAll) | Subscribe to internal Observables in order (wait for previous completion) |
...
If ordering is critical, use [concatAll](/pt/guide/operators/combination/concatAll).
