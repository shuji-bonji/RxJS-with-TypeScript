...
- **[race](/pt/guide/creation-functions/selection/race)** - Creation Function version
- **[mergeWith](/pt/guide/operators/combination/mergeWith)** - Execute all streams in parallel
- **[concatWith](/pt/guide/operators/combination/concatWith)** - Execute streams sequentially
