...
> see [Chapter 3: Creation Functions](/pt/guide/creation-functions/).
...
See [Creation Functions](/pt/guide/creation-functions/) for details.
...
The following are mainly used as Creation Functions (see [Chapter 3](/pt/guide/creation-functions/)).

|Function|Description|Pipeable Version|
|---|---|---|
|[concat](/pt/guide/creation-functions/combination/concat)|Combine sequentially|`concatWith` (RxJS 7+)|
|[merge](/pt/guide/creation-functions/combination/merge)|Combine in parallel|`mergeWith` (RxJS 7+)|
|[combineLatest](/pt/guide/creation-functions/combination/combineLatest)|Combine latest values|`combineLatestWith` (RxJS 7+)|
|[zip](/pt/guide/creation-functions/combination/zip)|Pair corresponding values|`zipWith` (RxJS 7+)|
|[race](/pt/guide/creation-functions/selection/race)|Adopt the fastest stream|`raceWith` (RxJS 7+)|
|[forkJoin](/pt/guide/creation-functions/combination/forkJoin)|Wait for all to complete|(No Pipeable version)|
