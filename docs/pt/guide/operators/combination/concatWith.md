...
- **[concat](/pt/guide/creation-functions/combination/concat)** - Creation Function version
- **[mergeWith](/pt/guide/operators/combination/mergeWith)** - Pipeable version for parallel combination
- **[concatMap](/pt/guide/operators/transformation/concatMap)** - Map each value sequentially
