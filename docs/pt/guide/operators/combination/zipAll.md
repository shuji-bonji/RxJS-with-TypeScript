...
See [Chapter 3: Creation Functions - zip](/pt/guide/creation-functions/combination/zip).

## 🔄 Related Operators

| Operator | Description |
|---|---|
| [combineLatestAll](/pt/guide/operators/combination/combineLatestAll) | Combine latest values of all internal Observables |
