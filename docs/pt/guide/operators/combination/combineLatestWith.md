...
- **[combineLatest](/pt/guide/creation-functions/combination/combineLatest)** - Creation Function version
- **[zipWith](/pt/guide/operators/combination/zipWith)** - Pair corresponding values (order guaranteed)
