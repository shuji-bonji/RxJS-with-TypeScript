...
> [!NOTE]
> `iif` and `defer` are **Creation Functions** (Observable creation functions) and are not conditional operators. See [Chapter 3: Creation Functions](/pt/guide/creation-functions/) for these.
