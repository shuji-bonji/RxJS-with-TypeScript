...
> [!TIP]
> For more information on schedulers, see [Types of Schedulers and How to Use Them](/pt/guide/schedulers/types.md).
...
- **[Asynchronous Processing Control](/pt/guide/schedulers/async-control.md)** - Scheduler Basics
