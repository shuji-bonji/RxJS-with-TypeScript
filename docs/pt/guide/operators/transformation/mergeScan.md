...
- [`scan`](/pt/guide/operators/transformation/scan) - Synchronous cumulative processing
- [`reduce`](/pt/guide/operators/transformation/reduce) - Outputs final cumulative value only on completion
- [`mergeMap`](/pt/guide/operators/transformation/mergeMap) - Asynchronous mapping (no accumulation)
- [`expand`](/pt/guide/operators/transformation/expand) - Recursive expansion process
