...
- [bufferToggle](/pt/guide/operators/transformation/bufferToggle) - Collect values as array (array version of windowToggle)
...
- [windowWhen](/pt/guide/operators/transformation/windowWhen) - Window splitting with dynamic closing conditions
