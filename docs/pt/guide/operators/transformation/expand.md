...
> [!TIP]
> When processing large amounts of data, you can use `asyncScheduler` to keep the UI responsive without blocking the main thread. For more information, please refer to [Scheduler Types and Usage](/pt/guide/schedulers/types).
...
- **[mergeMap](/pt/guide/operators/transformation/mergeMap)** - Learn normal asynchronous conversion
- **[switchMap](/pt/guide/operators/transformation/switchMap)** - Learn the conversion to switch to the latest process
- **[concatMap](/pt/guide/operators/transformation/concatMap)** - Learn conversions that are performed sequentially
- **[Scheduler Types and Usage](/pt/guide/schedulers/types)** - Learn to combine expand and schedulers
- **[Transformation Operator Practical Examples](/pt/guide/operators/transformation/practical-use-cases)** - Learn real use cases
