...
> [!TIP]
> For detailed usage and practical examples, see [of() detail page](/pt/guide/creation-functions/basic/of).
...
> [!TIP]
> For detailed usage and practical examples, see [from() detail page](/pt/guide/creation-functions/basic/from).
...
> [!TIP]
> For detailed usage and practical examples, see [fromEvent() detail page](/pt/guide/creation-functions/basic/fromEvent).
...
> [!TIP]
> For detailed usage and practical examples, see [interval() detail page](/pt/guide/creation-functions/basic/interval) and [timer() detail page](/pt/guide/creation-functions/basic/timer).
...
> [!TIP]
> For detailed usage and practical examples, see [ajax() detail page](/pt/guide/creation-functions/http-communication/ajax). For an overview of HTTP communication functions, see [HTTP Communication Creation Functions](/pt/guide/creation-functions/http-communication/).
...
> [!TIP]
> For detailed usage and practical examples, see [fromFetch() detail page](/pt/guide/creation-functions/http-communication/fromFetch). For an overview of HTTP communication functions, see [HTTP Communication Creation Functions](/pt/guide/creation-functions/http-communication/).
...
> [!TIP]
> For detailed usage and practical examples, see [scheduled() detail page](/pt/guide/creation-functions/control/scheduled). For an overview of control functions, see [Control Creation Functions](/pt/guide/creation-functions/control/).
...
> [!TIP]
> For detailed usage and practical examples, see [defer() detail page](/pt/guide/creation-functions/conditional/defer).
...
> [!TIP]
> For detailed usage and practical examples, see [range() detail page](/pt/guide/creation-functions/loop/range).
...
> [!TIP]
> For detailed usage and practical examples, see [generate() detail page](/pt/guide/creation-functions/loop/generate).
...
> [!TIP]
> For details on various Subject types (BehaviorSubject, ReplaySubject, AsyncSubject), see [Subject and Multicast](/pt/guide/subjects/what-is-subject).
...
> [!TIP]
> For detailed usage and practical examples, see [using() detail page](/pt/guide/creation-functions/control/using). For an overview of control functions, see [Control Creation Functions](/pt/guide/creation-functions/control/).
