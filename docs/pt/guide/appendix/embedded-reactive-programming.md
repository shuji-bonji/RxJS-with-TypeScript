...
- [How to create an Observable](/pt/guide/observables/creation) - Creating a sensor stream
- [Combination operators](/pt/guide/operators/combination/) - combineLatest, merge details
- [Filtering operators](/pt/guide/operators/filtering/) - filter, debounceTime utilization
- [Error handling](/pt/guide/error-handling/strategies) - handling sensor errors
- [Performance debugging](/pt/guide/debugging/performance) - monitor memory usage
