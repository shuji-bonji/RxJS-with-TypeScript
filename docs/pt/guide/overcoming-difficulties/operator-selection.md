...
- **[Chapter 4: Understanding Operators](/pt/guide/operators/)** - Details of all operators
- **[Chapter 13: Practical Patterns](/pt/guide/)** - Actual use cases (in preparation)
- **[Chapter 10: Common Mistakes and Solutions](/pt/guide/anti-patterns/common-mistakes)** - Anti-patterns for improper operator selection
