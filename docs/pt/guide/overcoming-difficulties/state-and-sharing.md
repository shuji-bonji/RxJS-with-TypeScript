...
→ **[Multiple stream combination](/pt/guide/overcoming-difficulties/stream-combination)** - How to use combineLatest, zip, withLatestFrom

## Related Pages

- **[Chapter 5: What is Subject](/pt/guide/subjects/what-is-subject)** - Basics of Subject
- **[Chapter 5: Types of Subject](/pt/guide/subjects/types-of-subject)** - Details of BehaviorSubject and ReplaySubject
- **[share() operator](/pt/guide/operators/multicasting/share)** - Detailed explanation of share
- **[Misuse of shareReplay](/pt/guide/anti-patterns/common-mistakes#4-sharereplay-)** - Common mistakes
- **[Cold vs Hot Observable](/pt/guide/observables/cold-and-hot-observables)** - Cold/Hot details
