...
- **[Chapter 8: RxJS Debugging Techniques](/pt/guide/debugging/)** - Overall debugging techniques
- **[Chapter 9: Marble Testing](/pt/guide/testing/marble-testing)** - Debugging with TestScheduler
- **[Understanding Timing and Order](/pt/guide/overcoming-difficulties/timing-and-order)** - Debugging with tap
- **[Chapter 10: Common Mistakes and Solutions](/pt/guide/anti-patterns/common-mistakes)** - Avoiding anti-patterns
