...
See [Testing Methodology](/pt/guide/testing/unit-tests) for more details.
...
- **[Common Mistakes and How to Deal with Them](/pt/guide/anti-patterns/common-mistakes#13-overcomplication)** - Anti-pattern of overcomplication
- **[Testing Techniques](/pt/guide/testing/unit-tests)** - How to test RxJS code
- **[Understanding Operators](/pt/guide/operators/)** - How to use each operator
