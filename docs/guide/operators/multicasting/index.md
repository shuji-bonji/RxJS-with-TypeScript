---
description: RxJSのマルチキャスティング関連オペレーターを解説します。share、shareReplay、publish、multicastの使い分け、コールドからホットへの変換、複数購読者への効率的な値配信、メモリリーク対策など、実践的なマルチキャスト戦略を紹介します。TypeScriptの型推論により型安全なストリーム共有を実現し、パフォーマンス最適化に役立つ実装パターンを学べます。
---
