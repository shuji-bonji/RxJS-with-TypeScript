---
description: RxJS変換オペレーター（map、mergeMap、switchMap、concatMap、scan、buffer等）の実践的なユースケースを解説します。ユーザー入力処理、APIレスポンス整形、ネストしたリクエスト、データ集計、ストリームの分割とバッチ処理など、データを柔軟に加工・変形する実践的なパターンをTypeScriptコード例とともに紹介します。実務で頻繁に使用される変換パターンを学べます。
---
